...
-- Instances:
local ToolGive = Instance.new("ScreenGui")
...
ToolGive.Name = "Arceus"
ToolGive.Enabled = true
ToolGive.ResetOnSpawn = true
ToolGive.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
ToolGive.DisplayOrder = 999999999
